        ...
        {features.map((item, idx) => (
          <TiltCard key={idx} className={`relative z-10 bg-gradient-to-br ${item.bg} p-6 rounded-2xl border ${item.border} backdrop-blur-xl group hover:scale-105 transition-all duration-300`}>
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2 flex items-center gap-2">{item.title}<span className="text-[10px] bg-white/10 px-2 py-0.5 rounded text-gray-300 uppercase tracking-wide border border-white/5">Coming Soon</span></h3>
